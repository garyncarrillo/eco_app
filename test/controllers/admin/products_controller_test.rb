...
class Admin::ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_product" do
    assert_difference('Admin::Product.count') do
      post admin_products_url, params: { admin_product: { description: @admin_product.description, high: @admin_product.high, observation: @admin_product.observation, weight: @admin_product.weight, width: @admin_product.width } }
    end
  ...
  test "should update admin_product" do
    patch admin_product_url(@admin_product), params: { admin_product: { description: @admin_product.description, high: @admin_product.high, observation: @admin_product.observation, weight: @admin_product.weight, width: @admin_product.width } }
